...
namespace PatientManagementSystem
{
    public partial class frmDoctorRegistration : Form
    {
        ...
        private void btnInitDevice_Click(object sender, EventArgs e)
        {
            ...
            {
                m_FPM.CloseDevice();
                btnInitDevice.Text = "Initialize Device";
            }
        }
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (picR1.Image != null && picR2.Image != null && picR3.Image != null)
                {
                    if (iError == (Int32)SGFPMError.ERROR_NONE)
                    {
        ...
        {
            string select = "SELECT DID, Finger1, Finger2, Finger3 FROM DoctorRegistration";
        ...
        private void btnR2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (iError == (Int32)SGFPMError.ERROR_NONE)
                {
                    ...
                    if (iError == (Int32)SGFPMError.ERROR_NONE)
                        StatusBars.Text = "Second image is captured";
                    else
                        DisplayError("CreateTemplate()", iError);
                }
                else
        ...
        private void btnR3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (iError == (Int32)SGFPMError.ERROR_NONE)
                {
                    ...
                    if (iError == (Int32)SGFPMError.ERROR_NONE)
                        StatusBars.Text = "Third image is captured";
                    else
                        DisplayError("CreateTemplate()", iError);
                }
                else
